...
use App\Ship_fee_district as MainModel;
use Illuminate\Support\Facades\Hash;
use Session;

class Ship_fee_districtController extends AdminController
{
    ...
    protected $listFields = [
        ...
        [ 'name' => 'fee_ship', 'label' => 'Price', 'type' => 'text'],
        [ 'name' => 'type', 'label' => 'Hình Thức giao hàng', 'type' => 'text'],
    ...
    protected $formFields = [
        'general_tab' => [
            ...
            'items' => [
                ...
                [ 'label' => 'Phí ship' ,'name' => 'fee_ship', 'type' => 'text'],
                [ 'label' => 'Type' ,'name' => 'type', 'type' => 'select','data_source' =>
                    [
                        'ship_fast' => 'Ship nhanh',
                        'ship_normal' => 'Ship thường',
                    ]
                ],
