...
class RankController extends AdminController
{
    ...
    protected $listFields = [
        ...
        [ 'name' => 'intro', 'label' => 'Intro', 'type' => 'thumb'],
        ...
        'general_tab' => [
            ...
            'items' => [
                ...
                [ 'label' => 'Vị trí hiển thị' ,'name' => 'location', 'type' => 'select','data_source' =>
                    [
                        'home_slider' => 'Hiển thị slider trang chủ',
                        'course_slider' => 'Hiển thị slider trang khóa học',
                        'banner_home' => 'Hiển thị Banner trang chủ',
                        'banner_home_below_slider' => 'Hiển thị Banner dưới slider trang chủ',
                    ]
                ],
