                ...
                <tr>
                    ...
                    <td>
                        <div class="el-button-group">
                            <a href="{{ route('admin.' . $controllerName . '.changePassword', ['id' => $id]) }}"
                                class="el-button el-button--default el-button--mini"><span>Change Password</span></a>
                            ...
                            <a href="javascript:deleteAction('{{ route('admin.' . $controllerName . '.destroy', ['id' => $id]) }}')"
                                class="el-button el-button--danger el-button--mini"><span><i
