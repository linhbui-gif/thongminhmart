                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <div class="form-item">
                                                ...
                                                <select name="province_id" class="@error('province_id') is-invalid @enderror custom-select form-control" id="select_tinh">
                                                    ...
                                                    @foreach($provinces as $k => $province)
                                                        <option @if($item->province_id == $province->id) selected @endif value="{{ $province->id }}">{{ $province->_name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('province_id')
                                            ...
                                            <input type="hidden" name="DistrictName" value="{{ $item->DistrictName }}">
                                            <input type="hidden" name="WardName" value="{{ $item->WardName }}">
                                        </div>
                                        <div class="form-group half">
                                            <div class="form-item">
                                                @php
                                                    $province = \App\Province::find($item->province_id);
                                                ...
                                                <select name="district_id" class="@error('district_id') is-invalid @enderror custom-select form-control" id="select_quan">
                                                    ...
                                                    @foreach($districts as $k => $district)
                                                        <option @if($item->district_id == $district->id) selected @endif value="{{ $district->id }}">{{ $district->_name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('district_id')
                                                <div class="alert alert-danger  mt-2">{{ $message }}</div>
                                        ...
                                        <div class="form-group half">
                                            <div class="form-item">
                                                @php
                                                    $district = \App\District::find($item->district_id);
                                                ...
                                                <select name="ward_id" class="@error('ward_id') is-invalid @enderror custom-select form-control" id="select_phuong">
                                                    ...
                                                    @foreach($wards as $k => $ward)
                                                        <option @if($item->ward_id == $ward->id) selected @endif value="{{ $ward->id }}">{{ $ward->_name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('ward_id')
                                                <div class="alert alert-danger  mt-2">{{ $message }}</div>
