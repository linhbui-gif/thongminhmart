        ...
        <div class="Footer-wrapper">
            <div class="Footer-wrapper-item">
                <div class="Footer-services flex items-center justify-between">
                    <div class="Footer-services-item flex items-center">
                        <div class="Footer-services-item-icon"> <img src="{{ asset('/assets/icons/icon-shield.svg') }}" alt=""></div>
                        <div class="Footer-services-item-title">DỊCH VỤ UY TÍN</div>
                    </div>
                    <div class="Footer-services-item flex items-center">
                        <div class="Footer-services-item-icon"> <img src="{{ asset('/assets/icons/icon-refresh.svg') }}" alt=""></div>
                        <div class="Footer-services-item-title">ĐỔI TRẢ TRÒNG VÒNG 7 NGÀY</div>
                    </div>
                    <div class="Footer-services-item flex items-center">
                        <div class="Footer-services-item-icon"> <img src="{{ asset('/assets/icons/icon-delivery.svg') }}" alt=""></div>
            ...
            <div class="Footer-wrapper-item flex justify-between">
                ...
                <div class="Footer-col">
                    ...
                    <div class="Footer-socials flex flex-wrap"><a class="Footer-socials-item" href="#" target="_blank"><img src="{{ asset('/assets/icons/icon-facebook.svg') }}" alt=""></a><a class="Footer-socials-item" href="#" target="_blank"><img src="{{ asset('/assets/icons/icon-youtube.svg') }}" alt=""></a><a class="Footer-socials-item" href="#" target="_blank"><img src="{{ asset('/assets/icons/icon-zalo.svg') }}" alt=""></a><a class="Footer-socials-item" href="#" target="_blank"><img src="{{ asset('/assets/icons/icon-tiktok.svg') }}" alt=""></a>
                        <div class="Footer-socials-item bct"><img src="{{ asset('/assets/images/logo-bct.svg') }}" alt=""></div>
                    </div>
                </div>
