        ...
        <div>
            ...
            <div style="display: flex; flex-wrap: wrap;">
                <div style="display: flex; margin: 0 2.4rem 2.4rem 0;">
                    ...
                    <div style="font-family: Roboto, sans-serif; font-size: 3.2rem; color: #1E2022; font-weight: 400; white-space: nowrap">37 Lê Đại Hành, Hai Bà Trưng, Hà Nội</div>
                </div>
                <div style="display: flex; margin: 0 2.4rem 2.4rem 0;">
                ...
                <div style="display: flex; margin: 0 2.4rem 2.4rem 0;">
                    <div style="flex: 0 0 2.8rem; max-width: 2.8rem; height: 2.8rem; margin: 0.4rem 0.8rem 0 0"><svg style="width: 100%; height: 100%" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M2.33301 13.9997C2.33301 7.55635 7.55635 2.33301 13.9997 2.33301C17.0939 2.33301 20.0613 3.56217 22.2493 5.7501C24.4372 7.93802 25.6663 10.9055 25.6663 13.9997C25.6663 20.443 20.443 25.6663 13.9997 25.6663C7.55635 25.6663 2.33301 20.443 2.33301 13.9997ZM20.9997 19.833V20.148C24.1064 16.4406 23.8659 10.974 20.4456 7.55374C17.0253 4.13346 11.5588 3.89297 7.85134 6.99967H15.7497C16.0718 6.99967 16.333 7.26084 16.333 7.58301V8.74967C16.333 9.07184 16.0718 9.33301 15.7497 9.33301H15.1663C14.522 9.33301 13.9997 9.85534 13.9997 10.4997V11.6663C13.9997 12.3107 13.4773 12.833 12.833 12.833H12.2497C11.9275 12.833 11.6663 13.0942 11.6663 13.4163C11.6663 13.7385 11.9275 13.9997 12.2497 13.9997H13.4163C13.7385 13.9997 13.9997 14.2608 13.9997 14.583V16.333H10.4997C9.85534 16.333 9.33301 15.8107 9.33301 15.1663V14.583C9.33301 14.2608 9.07184 13.9997 8.74967 13.9997H8.16634C7.52201 13.9997 6.99967 13.4773 6.99967 12.833V9.91634C6.99967 9.59418 6.73851 9.33301 6.41634 9.33301H5.92634C4.25995 12.2193 4.25904 15.7751 5.92395 18.6622C7.58885 21.5493 10.6669 23.3296 13.9997 23.333C14.3899 23.3294 14.7795 23.3022 15.1663 23.2513V19.2497C15.1727 19.0972 15.1165 18.9486 15.0108 18.8385C14.9051 18.7284 14.759 18.6662 14.6063 18.6663C14.4485 18.6695 14.2959 18.6098 14.1822 18.5004C14.0684 18.3909 14.0027 18.2408 13.9997 18.083V16.333H15.7497C16.0718 16.333 16.333 16.5942 16.333 16.9163C16.333 17.2385 16.5942 17.4997 16.9163 17.4997H18.083C18.4052 17.4997 18.6663 17.7608 18.6663 18.083C18.6663 18.4052 18.9275 18.6663 19.2497 18.6663H19.833C20.4773 18.6663 20.9997 19.1887 20.9997 19.833Z" fill="#1E2022"/></svg></div>
                    <div style="font-family: Roboto, sans-serif; font-size: 3.2rem; color: #1E2022; font-weight: 400; white-space: nowrap">Thongminhmart.com</div>
                </div>
                <div style="display: flex; margin: 0 2.4rem 2.4rem 0;">
