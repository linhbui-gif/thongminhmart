   ...
   <section class="section section-product">
       <div class="container">
           <div class="section-header d-flex align-items-center justify-content-between">
               <h2 class="d-flex align-items-center"> <img src="{{ asset('enduser/assets/icons/icon-book.svg') }}" alt="">Kết quản tìm kiếm cho: {{ @$category_name }}
               </h2>
               <div class="sort-group d-flex align-items-center">
                   <form id="fillter" class="sort-group d-flex align-items-center" action="{{ route('course.courseTagSlug', $slug) }}">
                       @php
