            ...
            <div class="Breadcrumb-wrapper">
                <div class="Breadcrumb-list flex flex-wrap"><a class="Breadcrumb-list-item" href="/">Trang chủ</a>
                    <div class="Breadcrumb-list-item arrow">
                        <svg width="9" height="14" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 1L7 7L1 13" stroke="#777777" stroke-width="1.5" stroke-linecap="round"/></svg></div><a class="Breadcrumb-list-item" href="danh-sach-san-pham.html">Danh sách sản phẩm</a>
                    <div class="Breadcrumb-list-item arrow">
                        <svg width="9" height="14" viewBox="0 0 9 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 1L7 7L1 13" stroke="#777777" stroke-width="1.5" stroke-linecap="round"/></svg></div><a class="Breadcrumb-list-item" href="chi-tiet-san-pham.html">Chi tiết</a>
                </div>
            </div>
        </div>
    </div>
    <div class="ProductDetailPage">
        <div class="container">
            <div class="ProductDetailPage-wrapper">
                <form class="Card ProductDetailPage-detail">
                    @csrf
                     <input type="hidden" name="product_id" value="{{$product->id}}">
                    <div class="Card-body">
                        <div class="ProductDetailPage-detail-wrapper flex flex-wrap">
                            <div class="ProductDetailPage-detail-image"> <img src="{{$product->url_picture}}" alt="{{$product->name}}">
                                <video class="ProductDetailPage-detail-video" defaultmuted autoplay loop muted playsinline preload="metadata">
                                    <source src="{{asset('storage/video-intro/'.$product->video_link)}}" type="video/mp4">
                                </video>
                                <div class="ProductDetailPage-detail-image-play active"><img src="./assets/icons/icon-play.svg" alt=""></div>
                            </div>
                            <div class="ProductDetailPage-detail-info">
                                ...
                                <div class="ProductDetailPage-detail-info-basic flex justify-between">
                                    <div class="ProductDetailPage-detail-info-basic-item">
                                        ...
                                        <div class="ProductDetailPage-detail-info-basic-price flex items-center"><span>{{number_format($product->price_final)}} đ</span>
                                            <del>{{number_format($product->price_base)}} đ</del>
                                        </div>
                                    </div>
                                    <div class="ProductDetailPage-detail-info-basic-item">
                                        <div class="ProductDetailPage-detail-info-text">MSP: {{"00" + $product->id}}</div>
                                    </div>
                                </div>
