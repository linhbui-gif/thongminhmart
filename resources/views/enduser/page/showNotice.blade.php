...
@section('content')
    @include("enduser.partials.breadcrumb",[ 'mainpage' => "Chi tiết thông báo",'name' =>$notice->name])
    <style>
        /*------- blog page start -------*/
        .ed_blog_all_item{
            float:left;
...
{{--                                <img src="{{$notice->getImage()}}" alt="blog image" width="100%">--}}
{{--                            </div>--}}
                            <div class="ed_blog_info">
                                <h2>{{$notice->name}}</h2>
                                <ul>
                                    {{--                                <li><a href="#"><i class="fa fa-user"></i> james marco</a></li>--}}
                                    <li><a href="#"><i class="fa fa-clock-o"></i> {{$notice->date_notification}}</a></li>
                            ...
                            <div class="ed_blog_tags">
                                <div><span>Share the post</span>
                                    <ul class="social_box">
                                        @php
                                            $linkShare = route("page.showNotice",  [ 'id' => $notice->id ] );
                                        @endphp
